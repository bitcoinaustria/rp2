...
- The primary consumer of this fork is Kassiber, which embeds RP2 as its tax engine via `kassiber/core/engines/rp2.py`. Kassiber normalizes raw transactions into RP2 inputs; RP2 owns the tax math.
